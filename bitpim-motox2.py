...
###
### Copyright (C) 2017
### Code adapted from Joe Pham <djpham@bitpim.org>
###
### This program is free software; you can redistribute it and/or modify
### it under the terms of the BitPim license as detailed in the LICENSE file.
###
### $Id: com_motox2.py XXXX 2017-11-28
...
parentphone=com_motox2.Phone
class Phone(parentphone):
    """ Talk to a Motorola X2 phone"""
    desc='Moto-X2'
    helpid=helpids.ID_PHONE_MOTOX2
    protocolclass=p_motox2
    serialsname='motox2'
    MODEOBEX='modeobex'
...
#------------------------------------------------------------------------------
parentprofile=com_motox2.Profile
